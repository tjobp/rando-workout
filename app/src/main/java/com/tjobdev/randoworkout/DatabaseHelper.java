...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    // used to keep only one database instance in the app - use this instead of
    // constructor
    ...
    public List<Exercise> getExercises( int selectedMuscle )
    {
        ...
        try
        {
            while( exerciseDbCursor.moveToNext() )
            {
                ...
                /*
                 * Log.d("db ex name", name); Log.d("db ex desc", description);
                 * Log.d("db ex primaryMuscle", primaryMuscle); Log.d("db ex secondaryMuscle",
                 * secondaryMuscles); Log.d("db ex equipment", equipment);
                 */
